	...
	<div id="main">
		...
		<div class="section border-bottom pt-11 pb-10">
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						<div class="text-center mb-1 section-pretitle">我们的厨师</div>
						<h2 class="text-center section-title mtn-2">我们有更接地气的厨师</h2>
				...
				<div class="row">
					<div class="col-md-4 col-sm-12">
						<div class="team-member">
							<div class="image">
								<img src="<%=basePath%>/resources/images/testimonial/picture_3.jpg" alt="Michael Andrews" />
							</div>
							<div class="team-info">
								<h5 class="name">一个男的</h5>
								<p class="bio">这里是他的简介。。。。。。。。。。。。。。。</p>
					...
					<div class="col-md-4 col-sm-12">
						<div class="team-member">
							<div class="image">
								<img src="<%=basePath%>/resources/images/testimonial/picture_4.jpg" alt="Kathleen Barsotti" />
							</div>
							<div class="team-info">
								<h5 class="name">一个女的</h5>
								<p class="bio">这里是她的简介</p>
								<ul class="social-list">
									<li><a href="#" data-toggle="tooltip" data-placement="top" data-original-title="Facebook"><i class="fa fa-facebook"></i></a></li>
									<li><a href="#" data-toggle="tooltip" data-placement="top" data-original-title="Google Plus"><i class="fa fa-google-plus"></i></a></li>
									<li><a href="#" data-toggle="tooltip" data-placement="top" data-original-title="Pinterest"><i class="fa fa-pinterest"></i></a></li>
					...
					<div class="col-md-4 col-sm-12">
						<div class="team-member">
							<div class="image">
								<img src="<%=basePath%>/resources/images/testimonial/picture_2.jpg" alt="Mark Ronson" />
							</div>
							<div class="team-info">
								<h5 class="name">另外一个男的</h5>
								<p class="bio">这里是他的简介</p>
								<ul class="social-list">
									<li><a href="#" data-toggle="tooltip" data-placement="top" data-original-title="Facebook"><i class="fa fa-facebook"></i></a></li>
									<li><a href="#" data-toggle="tooltip" data-placement="top" data-original-title="Google Plus"><i class="fa fa-google-plus"></i></a></li>
